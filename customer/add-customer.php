...
$title = 'Tambah custamor | Market PPLG';
            ...
            <div class="row">
              ...
              <div class="col-lg-8 mb-3">
                <div class="form-group">
                  ...
                  <input type="text" name="nama" id="nama customer" class="form-control" placeholder="Masukan nama customer" autofocus autocomplete="off" required>
                </div>
                <div class="form-group">
                  <label for="telpon">Telpon</label>
                  <input type="text" name="telpon" id="telpon customer" class="form-control" placeholder="nomor telepon customer" pattern="[0-9]{5,}" required>
                </div>
                
                <div class="form-group">
                  <label for="alamat">Alamat</label>
                  <textarea name="alamat" id="alamat customer" rows="1" class="form-control" placeholder="Alamat customer" required></textarea>
                </div>
              </div>
            </div>
          </div>
